...
import { lightMap } from '../../styles/theme';
...
const MapView = (): ReactElement => (
  <div>
    ...
    >
      <TileLayer
        url={`https://api.mapbox.com/styles/v1/corentin29/${lightMap}/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiY29yZW50aW4yOSIsImEiOiJja3V3dmgxOG0wMTdpMnZsOGs2OGU4eDQzIn0.p3UORX0_zEWs7XpxBBWMHA`}
      />
